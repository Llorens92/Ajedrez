...
public abstract class Pieza {
    ...
    /**
     * Objeto de clase Posición que indica la posición en que se encuentra la pieza
     */
    protected Posicion pos= new Posicion (fila,columna); 
    /**
     * Constructor que inicializa el color y la posición de la pieza
     * @param color Booleano que indica el color de la pieza (blancas true, negras false)
    ...
    /**
     * Método que mueve la pieza dentro del array en función de unos criterios (generalmente que el método movimiento valido sea true).
